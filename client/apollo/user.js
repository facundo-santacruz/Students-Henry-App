...
export const EDIT_USER = gql`mutation editUser($_id:String, $username: String, $lastName: String, $firstName: String, $cohorte: Int, $email: String, $nationality: String, $phone: String, $password: String, $image:String) {
	    editUser (input: {
            _id: $_id
            username: $username
            lastName: $lastName
